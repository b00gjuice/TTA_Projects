...
Users are reporting issues with the current system you’ve made. Specilically, they are having to manually
...
Use Ikinter module for the (il.
The layout of the UI is up to you.
You should use IDLE or any text editor that you are comfortable with for the Drill.
Once you create a functioning program that is approved by your instructor, save it for later use. Do not
modiFy this saved copy during subsequent drills.